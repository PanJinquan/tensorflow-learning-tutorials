...
from create_tf_record_batchSize import *
...
def train(train_record_file,
    ...
    train_images, train_labels = read_records(train_record_file, resize_height, resize_width, labels_nums,type='normalization')
...
if __name__ == '__main__':
    # train_record_file='../dataset/dataset_regression/record/train.tfrecords'
    # val_record_file='../dataset/dataset_regression/record/val.tfrecords'
    train_record_file = '/home/ubuntu/project/SmartAlbum/AVA_dataset/dataset/record/record.txt'#指定保存record的文件列表
    val_record_file='../dataset/dataset_regression/record/val.tfrecords'
