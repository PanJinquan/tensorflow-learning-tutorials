...
def disp_records(record_file,resize_height, resize_width,labels_num,show_nums=4):
    '''
...
def batch_test(record_file,resize_height, resize_width,labels_num):
    '''
...
if __name__ == '__main__':
    ...
    # 测试显示函数
    # disp_records(train_record_output,resize_height, resize_width,labels_num)
    # 产生val.record文件
    image_dir='dataset_regression/images'
