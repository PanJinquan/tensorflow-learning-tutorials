...
def maybe_download(url=CIFAR10_DATASET_URL, data_dir='cifar10_data'):
  import requests
  import tarfile
  
  if not os.path.exists(data_dir):
    r = requests.get(url)
    tar = '%s.tar.gz' % data_dir
...
def load_data(url=CIFAR10_DATASET_URL, data_dir='cifar10_data', image_size=32, batch_size=64):
