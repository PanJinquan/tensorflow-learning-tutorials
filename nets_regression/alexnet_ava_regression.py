...
if __name__ == '__main__':
    ...
    train_images_dir = '/home/ubuntu/project/SmartAlbum/AVA_dataset/dataset/prepro_images'
    val_images_dir="/home/ubuntu/project/SmartAlbum/AVA_dataset/dataset/prepro_images"

    train_filename = '/home/ubuntu/project/SmartAlbum/AVA_dataset/dataset/prepro_images_prob_distribution/train.txt'  # 训练的数据集
    val_filename = '/home/ubuntu/project/SmartAlbum/AVA_dataset/dataset/prepro_images_prob_distribution/val.txt'      # 验证的数据集
    test_path = '/home/ubuntu/project/SmartAlbum/AVA_dataset/dataset/prepro_images_prob_distribution/test.txt'    # 验证的数据集

    train_log_step=100
    base_lr = 0.0001  # 学习率
    train_samples=153304 #训练样本个数
    epochs = 2
    max_steps = train_samples*epochs # 总迭代次数
